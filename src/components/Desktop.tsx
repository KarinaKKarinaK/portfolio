...
const desktopIcons = [
  { id: "personas", imageSrc: "/icons/painting-personas.png", label: "AI Personas", left: "44%", top: "18%", window: "projects" as const },
  { id: "hft", imageSrc: "/icons/painting-hft.png", label: "HFT Research", left: "62%", top: "14%", window: "projects" as const },
  { id: "schnapsen", imageSrc: "/icons/painting-schnapsen.png", label: "Hybrid Intelligence", left: "54%", top: "44%", window: "projects" as const },
];
